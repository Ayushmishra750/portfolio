...
const COMMANDS: Record<string, () => OutputLine[]> = {
  ...
  skills: () => [
    ...
    { text: '  AWS Lambda   ████████████████      80%',   type: 'success' },
    { text: '', type: 'blank' },
    { text: '  ── Cloud & Big Data ────────────────────', type: 'header' },
    { text: '  Athena · EMR · Redshift · CloudWatch',      type: 'info' },
    { text: '', type: 'blank' },
    ...
    { text: '', type: 'blank' },
    { text: '  ── Analytics & BI ──────────────────────', type: 'header' },
    { text: '  Tableau · Advanced Excel · Pandas · NumPy', type: 'accent' },
    { text: '', type: 'blank' },
    { text: '  ── Modern Data Stack (learning) ────────', type: 'header' },
    { text: '  Airflow · dbt · Docker · Databricks',       type: 'muted' },
    { text: '', type: 'blank' },
    { text: '  ── Tools ───────────────────────────────', type: 'header' },
    { text: '  Git · Jira · Linux · Jupyter · VS Code',    type: 'muted' },
    { text: '', type: 'blank' },
  ],
